...
public class EaseChatPrimaryMenu extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    public Button btnBetting;   //投注按钮
    public Button btnCancelOrder;//撤单按钮
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        btnBetting = (Button) findViewById(R.id.btnBetting);//投注
        btnCancelOrder = (Button) findViewById(R.id.btnCancelOrder);//撤单
...
//            buttonSetModeVoice.setVisibility(View.VISIBLE);
        ...
        } else if(id == R.id.btnBetting) {
            if(listener != null){
                listener.onBetBtnClicked();
            }
        }else if(id == R.id.btnCancelOrder) {
            if(listener != null){
                listener.onCancleOrderClicked();
            }
        }
    }
