...
public class EaseChatInputMenu extends LinearLayout {
    ...
    protected void processChatMenu() {
        ...
        chatPrimaryMenu.setChatPrimaryMenuListener(new EaseChatPrimaryMenuListener() {
            ...
            public void onBetBtnClicked() {
                if(betListener != null)
                    betListener.onBetBtnClicked();
            }

            @Override
            public void onCancleOrderClicked() {
                if(betListener != null)
                    betListener.onCancleOrderClicked();
            }
    ...
    protected OnBetListener betListener;
    public void setOnBetListener(OnBetListener listener) {
        this.betListener = listener;
    }

    public interface OnBetListener {
        void onBetBtnClicked();
        void onCancleOrderClicked();
    }
}
