...
*/
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (msgCount < conversation.getAllMsgCount() && msgCount < pagesize) {
                    ...
                    List<EMMessage> msgs2= conversation.loadMoreMsgFromDB(msgId, pagesize - msgCount);
                }
            }
        },3000);
    }
    ...
    protected void showChatroomToast(final String toastContent){
       ...
       public static  HashMap<String,Set<EMMessage>> msgMap=new HashMap<String,Set<EMMessage>>();
    // implement methods in EMMessageListener
    @Override
    public void onMessageReceived(List<EMMessage> messages) {
        Set<EMMessage> set=new HashSet<>();
        set.addAll(messages);
        Set<EMMessage> emMessages = msgMap.get(toChatUsername);
        if(emMessages==null){
